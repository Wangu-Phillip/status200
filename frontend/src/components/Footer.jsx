        ...
        <div className="grid md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex space-x-3 mt-6">
              <a href="#" className="w-9 h-9 bg-white/10 rounded-full flex items-center justify-center hover:bg-[#F47920] transition-colors">
        ...
        <div className="border-t border-white/10 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm gap-4">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <a href="#" className="hover:text-[#F47920] transition-colors">Privacy Policy</a>
              <a href="#" className="hover:text-[#F47920] transition-colors">Terms of Service</a>
              <a href="#" className="hover:text-[#F47920] transition-colors">Cookie Policy</a>
            </div>
          </div>
        </div>
      </div>
