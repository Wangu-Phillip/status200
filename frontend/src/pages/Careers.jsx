      ...
      <section id="positions" className="py-24 bg-slate-900 text-white relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="mt-16 text-center">
             ...
             <Button variant="outline" className="border-white/20 text-white hover:bg-white/5 rounded-sm">
         ...
         <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
               ...
               <div className="flex flex-wrap gap-4 justify-center">
                  <Button size="lg" className="bg-[#75B2DD] hover:bg-[#5a9ac9] text-[#0A192F] font-bold rounded-sm px-10">
                     View All Locations
                  </Button>
         ...
         <Card className="bg-white/5 border border-white/10 rounded-sm hover:bg-white/[0.08] transition-all cursor-pointer group">
            <CardContent className="p-8 flex flex-col md:flex-row md:items-center justify-between gap-8">
               ...
               <div className="flex-shrink-0 flex items-center justify-end">
                  <Button className="bg-white/5 hover:bg-[#75B2DD] group-hover:text-[#0A192F] text-white border border-white/10 group-hover:border-[#75B2DD] font-bold rounded-sm px-6">
                     Apply Now
